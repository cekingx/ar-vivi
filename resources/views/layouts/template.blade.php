...
<html lang="en">
  <head>
    ...
    <link href="{{ asset('sbadmin-template/css/sb-admin-2.min.css') }}" rel="stylesheet">
  ...
  <body id="page-top">
          ...
          <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="{{ route('home') }}" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <!-- Page level plugins -->
    <script src="{{ asset('sbadmin-template/vendor/chart.js/Chart.min.js') }}"></script>
